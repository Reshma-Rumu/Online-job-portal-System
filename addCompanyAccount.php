                                ...
                                <div class="col-lg-12">
                                    <section class="panel">
                                        ...
                                        <div class="panel-body">
                                            <div class="form">
                                                <form class="cmxform form-horizontal tasi-form" id="insertjobForm" method="POST" action="action/addCompanyAccountAction.php">

                                                    <div class="form-group ">
                                                        <label for="jobtitle" class="control-label col-lg-2">Balance</label>
                                                        <div class="col-lg-10">
                                                            <input class=" form-control" id="jobtitle" name="total" type="text" />
                                                        </div>
                                                    </div>
