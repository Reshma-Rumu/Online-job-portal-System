                                            ...
                                            <div class="form">
                                                <form class="cmxform form-horizontal tasi-form" id="insertjobForm" method="POST" action="action/postAJobsAction.php">
                                                    ...
                                                    <div class="form-group ">
                                                        ...
                                                        <div class="col-lg-10">
                                                            <input class=" form-control" id="company_name" value="<? echo $companyName ?>" name="company_name" type="text" />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group ">
                                                        ...
                                                        <div class="col-lg-10">
                                                            <select class=" form-control" name="jobcategory">
                                                                ...
                                                                <option value="11">Media / Event Management </option>
                                                                <option value="12">Admin</option>
                                                                <option value="13">Design / Creative </option>
                                                                ...
                                                                <option value="19">Beauty Care / Health </option>
                                                                <option value="20">Research / Consultancy </option>
                                                                <option value="21">Data Entry / BPO </option>
                                                                <option value="22">Security / Law </option>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-3 col-xs-11">
                                                            ...
                                                            <div class="input-append date dpYears" data-date="12-02-2012" data-date-format="dd-mm-yyyy" data-date-viewmode="years">
                                                                <input type="text" name="applicationdeadline" id="datepicker">
                                                    ...
                                                    <div class="form-group ">
                                                        ...
                                                        <div class="col-lg-10">
                                                            <input class=" form-control" id="no_of_vacancies" name="no_of_vacancies" type="text" />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group ">
                                                        ...
                                                        <div class="col-lg-10">
                                                            <textarea class="form-control " name="educationalrequirements" rows="6"></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="form-group ">
                                                        <label for="additionaljobrequirements" class="control-label col-lg-2">Job Requirements</label>
                                                        <div class="col-lg-10">
                                                            <textarea class="form-control" name="additionaljobrequirements" rows="6"></textarea>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group ">
                                                        ...
                                                        <div class="col-lg-10">
                                                            <input class=" form-control" id="company_location" value="<? echo $companyAddress ?>" name="company_location" type="text" />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group ">
                                                        ...
                                                        <div class="col-lg-10">
                                                            <input class=" form-control" id="company_email" value="<? echo $companyEmail ?>" name="company_email" type="text" />
                                                        </div>
                                                    </div>
                                                    <div class="form-group ">
                                                        <label for="apply_instruction" class="control-label col-lg-2">apply_instruction</label>
                                                        <div class="col-lg-10">
                                                            <input class=" form-control" id="apply_instruction" placeholder="Short Instruction for candidates (Ex: Send Your CV to: youremail@gmail.com. Applicant must enclose his/her Photograph with CV) " name="apply_instruction" type="text" />
                                                        </div>
                                                    </div>
