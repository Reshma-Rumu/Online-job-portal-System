                    ...
                    <div class="row">
                        ...
                        <aside class="profile-info col-lg-9">
                            ...
                            <tbody>
                                ...
                                <?
                        $jobsId = $_GET['jobsId'];
                        $query = "select * from online_applications join jobseeker on jobseeker.seeker_id = online_applications.seeker_id where online_applications.jobs_id='$jobsId'";
                        $queryExecute = mysqli_query($con,$query);
                        while ($row = mysqli_fetch_array($queryExecute)) {
                            ?>

                           <tr> 
                          <td><img class="img-rounded" width="100" height="100" src="seekerimage/<?php echo $row['filename'] ?>"></td>     
                          <td><?php echo $row['name'] ?></td>
                          <td><?php echo $row['mobilenumber'] ?></td>                          
                          <td><a class="btn btn-shadow btn-info" href="viewCandidatesCvUi.php?seekerId=<?php echo $row['seeker_id'] ?>">Full View</a></td> 
                          </tr>
