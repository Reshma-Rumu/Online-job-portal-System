          ...
          <section id="main-content">
                <section class="wrapper">
                    ...
                    <div class="row state-overview">
                        <!--<header class="panel-heading"><i class=" icon-h-sign"></i> Hot Jobs </header>-->

                        <?
                        $jobsId = $_GET['companyId'];
                        include 'database/db.php';
                        $query = "select * from jobs where company_id='$jobsId'";
