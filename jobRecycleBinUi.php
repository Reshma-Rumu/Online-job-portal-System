            ...
            <section id="main-content">
                <section class="wrapper">
                    ...
                    <div class="row">
                        ...
                        $query = "select * from jobs where status='0' and company_id='$companyId'";
                        $queryExecute = mysqli_query($con,$query);
                        while ($row = mysqli_fetch_array($queryExecute)) {
                            ?>
                          ...
                          <td><a class="btn btn-shadow btn-danger" href="action/publishFromJobRecycleBinAction.php?jobsId=<?php echo $row['id'] ?>">Publish</a></td> 
                          </tr>
