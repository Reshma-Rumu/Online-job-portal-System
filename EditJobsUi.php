                                ...
                                <div class="col-lg-12">
                                    <section class="panel">
                                        ...
                                        <div class="panel-body">
                                            <div class="form">
                                                <form class="cmxform form-horizontal tasi-form" id="insertjobForm" method="POST" action="action/EditAJobsAction.php">

  
                                                    <input name="jobId" type="hidden" value="<?= $jobsId;?>" />
                                                    <div class="form-group ">
                                                        <label for="jobtitle" class="control-label col-lg-2">Job Title</label>
                                                        <div class="col-lg-10">
                                                            <input class=" form-control" id="jobtitle" name="jobtitle" type="text" value="<?=$row['jobs_title'];?>" />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group ">
                                                        ...
                                                        <div class="col-lg-10">
                                                            <input class="form-control" id="company_name" value="<? echo $companyName ?>" name="company_name" type="text" value="<?=$row['company_name'];?>"/>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group ">
                                                        ...
                                                        <div class="col-lg-10">
                                                            <select class=" form-control" name="jobcategory">
                                                                <option value="<?=$row['job_category'];?>">Select Job Category </option>
                                                    ...
                                                    <div class="form-group">
                                                        <label class="control-label col-md-3">Application Deadline</label>
                                                        <div class="col-md-3 col-xs-11">

                                                            <div class="input-append date dpYears" data-date="12-02-2012" data-date-format="dd-mm-yyyy" data-date-viewmode="years">
                                                                <input type="text" name="applicationdeadline" id="datepicker" value="<?=$row['applicationdeadline'];?>">
                                                    ...
                                                    <div class="form-group ">
                                                        ...
                                                        <div class="col-lg-10">
                                                            <input class=" form-control" id="no_of_vacancies" name="no_of_vacancies" type="text" value="<?=$row['no_of_vacancies'];?>" />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group ">
                                                      ...
                                                      <div class="col-lg-10">
                                                            <textarea class="form-control" name="jobdescription" rows="6"><?=$row['jobdescription'];?></textarea>
                                                    ...
                                                    <div class="form-group ">
                                                        ...
                                                        <div class="col-lg-10">
                                                            <textarea class="form-control " name="educationalrequirements" rows="6"><?=$row['educationalrequirements'];?></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="form-group ">
                                                        <label for="additionaljobrequirements" class="control-label col-lg-2">Job Requirements</label>
                                                        <div class="col-lg-10">
                                                            <textarea class="form-control" name="additionaljobrequirements" rows="6"><?=$row['additionaljobrequirements'];?></textarea>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group ">
                                                        ...
                                                        <div class="col-lg-10">
                                                            <input class=" form-control" id="salary" name="salary" type="text" value="<?=$row['salary'];?>"/>
                                                        </div>
                                                    </div>
                                                    <div class="form-group ">
                                                        <label for="company_location" class="control-label col-lg-2">Company Location</label>
                                                        <div class="col-lg-10">
                                                            <input class=" form-control" id="company_location" value="<?= $row['company_location'];?>" name="company_location" type="text" />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group ">
                                                        ...
                                                        <div class="col-lg-10">
                                                            <input class=" form-control" id="company_email" value="<?= $row['company_email']?>" name="company_email" type="text" />
                                                        </div>
                                                    </div>
                                                    <div class="form-group ">
                                                        <label for="apply_instruction" class="control-label col-lg-2">Apply_instruction</label>
                                                        <div class="col-lg-10">
                                                            <input class=" form-control" id="apply_instruction" placeholder="Short Instruction for candidates (Ex: Send Your CV to: youremail@gmail.com. Applicant must enclose his/her Photograph with CV) " name="apply_instruction" type="text" value="<?= $row['apply_instruction'];?>" />
                                                        </div>
                                                    </div>
